...
-- 固定 id：component_maps 150–151、components 300–301、dashboard 400（若與現有環境衝突請改 id）
...
DELETE FROM dashboard_groups WHERE dashboard_id = 400;
DELETE FROM dashboards WHERE id = 400 OR index = 'ntpc_waste_maps_mvp';
...
(400, 'ntpc_waste_maps_mvp', '新北垃圾／回收地圖', ARRAY[300, 301]::int[], 'recycling', NOW(), NOW());

INSERT INTO dashboard_groups (dashboard_id, group_id) VALUES (400, 3);
