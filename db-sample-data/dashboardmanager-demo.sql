...
moenv_wr_recycle_6ca8d697f6	{#E170A6,#E170A6,#E170A6}	{BarChart}	處
moenv_wr_recycle_7b805c8fa1	{#24B0DD,#24B0DD,#24B0DD}	{BarChart}	處
moenv_wr_recycle_6a4bc66658	{#56B96D,#56B96D,#56B96D}	{BarChart}	處
moenv_wr_recycle_014ce45e54	{#F8CF58,#F8CF58,#F8CF58}	{BarChart}	處
moenv_wr_recycle_8863327e9b	{#F5AD4A,#F5AD4A,#F5AD4A}	{BarChart}	處
moenv_wr_recycle_c5e75de7e7	{#9DC56E,#9DC56E,#9DC56E}	{BarChart}	處
moenv_wr_recycle_e62fbe91a5	{#8B5CF6,#8B5CF6,#8B5CF6}	{BarChart}	處
moenv_wr_recycle_4554828c57	{#ED6A45,#ED6A45,#ED6A45}	{BarChart}	處
\.
...
111	moenv_wr_recycle_6ca8d697f6	回收點｜3C用品類	circle	geojson	small	\N	{"circle-color":"#E170A6","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
112	moenv_wr_recycle_7b805c8fa1	回收點｜其他類	circle	geojson	small	\N	{"circle-color":"#24B0DD","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
113	moenv_wr_recycle_6a4bc66658	回收點｜家具類	circle	geojson	small	\N	{"circle-color":"#56B96D","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
114	moenv_wr_recycle_014ce45e54	回收點｜書籍類	circle	geojson	small	\N	{"circle-color":"#F8CF58","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
115	moenv_wr_recycle_8863327e9b	回收點｜玩具類	circle	geojson	small	\N	{"circle-color":"#F5AD4A","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
116	moenv_wr_recycle_c5e75de7e7	回收點｜生活用品類	circle	geojson	small	\N	{"circle-color":"#9DC56E","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
117	moenv_wr_recycle_e62fbe91a5	回收點｜舊衣類	circle	geojson	small	\N	{"circle-color":"#8B5CF6","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
118	moenv_wr_recycle_4554828c57	回收點｜電器類	circle	geojson	small	\N	{"circle-color":"#ED6A45","circle-opacity":0.85,"circle-radius":5,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}	[{"key":"site_name","name":"點位名稱"},{"key":"full_address","name":"地址"},{"key":"item","name":"回收類別"},{"key":"service_type","name":"服務類型"},{"key":"tel","name":"電話"}]
\.
...
360	garbage_map_metrotaipei	垃圾地圖	{219,220,999,221,222,223,224,225,226,227,228}	delete	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00
...
moenv_wr_recycle_6ca8d697f6	\N	{111}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：3C用品類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含 3C用品類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('新北市板橋區','點位數','處',10),('新北市蘆洲區','點位數','處',6),('臺北市文山區','點位數','處',4),('臺北市內湖區','點位數','處',4),('基隆市仁愛區','點位數','處',4),('新北市新店區','點位數','處',3),('新北市三重區','點位數','處',3),('基隆市七堵區','點位數','處',3),('基隆市安樂區','點位數','處',3),('新北市樹林區','點位數','處',3),('新北市新莊區','點位數','處',3),('臺北市南港區','點位數','處',2),('臺北市中山區','點位數','處',2),('臺北市大同區','點位數','處',2),('基隆市中山區','點位數','處',2),('臺北市信義區','點位數','處',2),('基隆市信義區','點位數','處',2),('新北市三峽區','點位數','處',2),('臺北市松山區','點位數','處',1),('新北市五股區','點位數','處',1),('新北市中和區','點位數','處',1),('基隆市中正區','點位數','處',1),('臺北市北投區','點位數','處',1),('臺北市士林區','點位數','處',1),('新北市汐止區','點位數','處',1),('新北市土城區','點位數','處',1),('新北市淡水區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_7b805c8fa1	\N	{112}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：其他類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含其他類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('臺北市信義區','點位數','處',6),('臺北市士林區','點位數','處',5),('臺北市文山區','點位數','處',4),('臺北市萬華區','點位數','處',4),('臺北市中正區','點位數','處',3),('臺北市大同區','點位數','處',3),('臺北市中山區','點位數','處',2),('臺北市內湖區','點位數','處',2),('臺北市大安區','點位數','處',2),('臺北市松山區','點位數','處',1),('新北市蘆洲區','點位數','處',1),('新北市新莊區','點位數','處',1),('新北市中和區','點位數','處',1),('新北市三重區','點位數','處',1),('新北市新店區','點位數','處',1),('新北市板橋區','點位數','處',1),('新北市土城區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_6a4bc66658	\N	{113}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：家具類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含家具類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('臺北市內湖區','點位數','處',3),('臺北市南港區','點位數','處',2),('臺北市中山區','點位數','處',2),('臺北市松山區','點位數','處',1),('臺北市萬華區','點位數','處',1),('臺北市信義區','點位數','處',1),('臺北市北投區','點位數','處',1),('臺北市士林區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_014ce45e54	\N	{114}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：書籍類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含書籍類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('臺北市士林區','點位數','處',3),('臺北市南港區','點位數','處',2),('新北市三重區','點位數','處',2),('新北市蘆洲區','點位數','處',2),('臺北市北投區','點位數','處',2),('臺北市文山區','點位數','處',1),('臺北市中正區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_8863327e9b	\N	{115}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：玩具類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含玩具類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('臺北市士林區','點位數','處',3),('臺北市文山區','點位數','處',2),('新北市三重區','點位數','處',2),('新北市蘆洲區','點位數','處',2),('臺北市南港區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_c5e75de7e7	\N	{116}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：生活用品類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含生活用品類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('新北市三重區','點位數','處',7),('新北市蘆洲區','點位數','處',5),('臺北市信義區','點位數','處',5),('新北市板橋區','點位數','處',4),('臺北市萬華區','點位數','處',4),('新北市新莊區','點位數','處',3),('新北市中和區','點位數','處',3),('臺北市文山區','點位數','處',3),('臺北市大同區','點位數','處',3),('臺北市中山區','點位數','處',2),('臺北市士林區','點位數','處',2),('新北市新店區','點位數','處',1),('新北市汐止區','點位數','處',1),('臺北市南港區','點位數','處',1),('臺北市內湖區','點位數','處',1),('臺北市大安區','點位數','處',1),('臺北市中正區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_e62fbe91a5	\N	{117}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：舊衣類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含舊衣類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('新北市板橋區','點位數','處',34),('新北市蘆洲區','點位數','處',17),('新北市新莊區','點位數','處',12),('新北市樹林區','點位數','處',12),('臺北市士林區','點位數','處',11),('新北市淡水區','點位數','處',9),('臺北市大同區','點位數','處',9),('新北市三重區','點位數','處',7),('臺北市大安區','點位數','處',6),('臺北市松山區','點位數','處',5),('臺北市南港區','點位數','處',5),('臺北市中山區','點位數','處',5),('臺北市萬華區','點位數','處',4),('臺北市文山區','點位數','處',3),('基隆市暖暖區','點位數','處',2),('臺北市內湖區','點位數','處',1),('臺北市中正區','點位數','處',1),('臺北市北投區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_4554828c57	\N	{118}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：電器類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含電器類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('新北市中和區','點位數','處',3),('新北市三重區','點位數','處',3),('臺北市萬華區','點位數','處',3),('臺北市內湖區','點位數','處',2),('臺北市中山區','點位數','處',2),('新北市蘆洲區','點位數','處',2),('臺北市信義區','點位數','處',2),('新北市新莊區','點位數','處',1),('臺北市南港區','點位數','處',1)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
\.
