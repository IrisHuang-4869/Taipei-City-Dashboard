...
moenv_wr_recycle_6ca8d697f6	\N	{111}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：3C用品類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含 3C用品類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('3C用品類','點位數','處',69)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_7b805c8fa1	\N	{112}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：其他類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含其他類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('其他類','點位數','處',39)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_6a4bc66658	\N	{113}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：家具類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含家具類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('家具類','點位數','處',12)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_014ce45e54	\N	{114}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：書籍類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含書籍類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('書籍類','點位數','處',13)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_8863327e9b	\N	{115}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：玩具類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含玩具類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('玩具類','點位數','處',10)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_c5e75de7e7	\N	{116}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：生活用品類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含生活用品類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('生活用品類','點位數','處',47)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_e62fbe91a5	\N	{117}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：舊衣類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含舊衣類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('舊衣類','點位數','處',144)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
moenv_wr_recycle_4554828c57	\N	{118}	{}	static	\N	0	\N	環境部	北北基 MOENV 回收點：電器類。	圖層來自環境部回收點位公開資料；範圍僅臺北市、新北市、基隆市（已排除桃園市）；單一圖層僅含電器類。	於地圖模式可獨立開關本圖層以檢視點位與屬性。	{}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	three_d	select * from (values ('電器類','點位數','處',19)) as t(x_axis,y_axis,icon,data)	\N	metrotaipei
\.
