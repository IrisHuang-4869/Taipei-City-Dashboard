export const localGarbageMapLayers = [
	{
		...
		short_desc:
			"整合台北市垃圾車收運點位與垃圾資源回收、廚餘回收限時收受點。",
		long_desc:
			"整合台北市垃圾車收運點位與垃圾資源回收、廚餘回收限時收受點，並提供圖層分類切換。",
	...
	},
	{
		...
		update_freq_unit: null,
		short_desc:
			"整合台北市與新北市的垃圾清運站點，含台北市限時收受點特別標記。",
		long_desc:
			"整合台北市垃圾車收運點位、台北市限時收受點（特別標記），以及新北市循線、機動、限時與臨停清運點，提供雙北垃圾車圖層分類切換。",
		use_case: "用於查找雙北垃圾車站點位置與分類資訊。",
		links: [
			"https://data.taipei/dataset/detail?id=6bb3304b-4f46-4bb0-8cd1-60c66dcd1cae",
			"https://data.taipei/dataset/detail?id=1acf38f3-1509-4cb1-898a-9b1d4f31a3af",
	...
	},
	{
		...
		long_desc:
			"整合新北市黃金資收站查詢頁與公告 PDF 的站點、里長、時間與聯絡資訊。",
